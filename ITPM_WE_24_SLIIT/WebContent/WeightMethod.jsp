...
<div class="container">
 <div class="row">
 <div class="col-8"> 
<center><h2>Change weight here......</h2></center>
	<form action = "WeightMethod" method= POST>
	
	<div style = "width : 70%; float : left;" class="input-group-text">
		<center>	<table  border="1" style="text-align:center;"  style="float-align:center;" >
			...
			<center><input  class="btn btn-primary" type = "submit" name = "submit" value = "save" style = "height: 50px; width: 100px"></center>
			</div>
</form>
</div>
</body>
