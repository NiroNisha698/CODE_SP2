...
<body>
<center><h3>Complexity of Variable</h3></center>
<center>
<div  border="1" font-size="200%" style="text-align:center;margin-top:  100px; float-align:center;width : 32%; float : center;" class="input-group-text" ">
 <div class="row">
 <div class="col-8"> 
 ${tb}
</div>
