<%@page import="NiroCom.FileUpload"%>
...
<form action= 'inheritance_FileSelectServlet'>
<%
...
%>
			...
			<div>
			<form action= "NirocodeServlet" method  = POST>
			...
			<div class="btn-group">
			<input class = "btn btn-primary" type = "submit" name = "button" value = "Ci Value" style = "height: 50px; width: 200px">
			</div>
