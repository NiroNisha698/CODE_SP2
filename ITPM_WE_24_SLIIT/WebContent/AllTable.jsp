...
<br>
	...
	<div style="background-color: #F4F7FF;" class=box1; ">
		...
		<div class="heading">
				...
				<h3 class="kt-portlet__head-title kt-font-brand;" style="text-align:center;">Displaying the complexity of a program due to all the factors </h3>
			</div>
						...
						<div
							...
							class="container">
							<h1 style="text-align: center">All Factor - File Upload</h1>
  					...
  					<form action= "All_FileUploadServlet" method="post" enctype="multipart/form-data" id = bottom>
